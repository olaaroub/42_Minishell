...
/*   Updated: 2024/11/13 00:15:19 by olaaroub         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int handle_redirs(t_tokens **temp, t_redir **redir, char **commands, int *i)
{
...
static void fill_commands_redirs(t_tokens **temp, t_redir **redir, char **commands)
{
    int i;
